            ...
            records.eachWithIndex { Map record, int index ->
                if (AirportStatus.countByAirfieldName(record.name as String) == 0) {
                    ...
                    AirportStatus status = new AirportStatus(
                        ...
                        muns: record.muns,
                        munsRemarks: record.muns == NA ? 'Not applicable for this location.' : 'Munitions support status seeded for testing.',
                        pol: record.pol,
                        ...
                        baseDefenseRemarks: 'Base defense status seeded for testing.',
