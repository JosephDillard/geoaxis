...
<body>
<a href="#create-engineerAssets" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="create-engineerAssets" class="content scaffold-create" role="main">
    <h1>Add Engineer Asset</h1>
    ...
    <g:form url="[resource: engineerAssets, action: 'save']">
        <fieldset class="form">
