...
class AirportStatus {
    ...
    static mapping = {
        opsRemarks type: 'text', sqlType: 'clob'
        mxRemarks type: 'text', sqlType: 'clob'
        munsRemarks type: 'text', sqlType: 'clob'
        polRemarks type: 'text', sqlType: 'clob'
        rwPriRemarks type: 'text', sqlType: 'clob'
        rwSecRemarks type: 'text', sqlType: 'clob'
        airfieldRemarks type: 'text', sqlType: 'clob'
        infraRemarks type: 'text', sqlType: 'clob'
        atcalsNavaidsRemarks type: 'text', sqlType: 'clob'
        c4iRemarks type: 'text', sqlType: 'clob'
        cyberRemarks type: 'text', sqlType: 'clob'
        radioRemarks type: 'text', sqlType: 'clob'
        baseDefenseRemarks type: 'text', sqlType: 'clob'
