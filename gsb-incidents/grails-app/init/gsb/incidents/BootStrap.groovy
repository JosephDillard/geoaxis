    ...
    private void seedArchivedIncidentData() {
        Incidents.withTransaction {
            ...
            List<Map> records = [
                ...
                [incidentId: 'ARC-NM-0004', eventType: 'Security', eventName: 'Perimeter sensor reset', eventDesc: 'Archived record for a nuisance alarm reset at Roswell.', mgrsCoord: '13SEC9135576021', base: 'Roswell Air Center', sigEvent: 'No', airOpsAffected: 'No', source: 'Security Forces', eventCat: 'Security'],
