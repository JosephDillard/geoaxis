...
<html>
	...
	<body>
		<a href="#show-incidents" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-incidents" class="content scaffold-show" role="main">
			<h1><g:message code="default.show.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<ol class="property-list incidents">
			
				<g:if test="${incidents?.incidentId}">
				<li class="fieldcontain">
					<span id="incidentId-label" class="property-label"><g:message code="incidents.incidentId.label" default="Incident Id" /></span>
				...
				<li class="fieldcontain">
					<span id="eventType-label" class="property-label"><g:message code="incidents.eventType.label" default="Event Type" /></span>
				...
				<g:if test="${incidents?.eventCat}">
					<li class="fieldcontain">
						<span id="eventCat-label" class="property-label"><g:message code="incidents.eventCat.label" default="Category" /></span>
				...
				<li class="fieldcontain">
					<span id="eventName-label" class="property-label"><g:message code="incidents.eventName.label" default="Event Name" /></span>
				...
				<li class="fieldcontain">
					<span id="eventDesc-label" class="property-label"><g:message code="incidents.eventDesc.label" default="Event Desc" /></span>
				...
				<li class="fieldcontain">
					<span id="mgrsCoord-label" class="property-label"><g:message code="incidents.mgrsCoord.label" default="Mgrs Coordinates" /></span>
				...
				<li class="fieldcontain">
					<span id="base-label" class="property-label"><g:message code="incidents.base.label" default="Location" /></span>
				...
				<li class="fieldcontain">
					<span id="sigEvent-label" class="property-label"><g:message code="incidents.sigEvent.label" default="Sig Event" /></span>
				...
				<li class="fieldcontain">
					<span id="airOpsAffected-label" class="property-label"><g:message code="incidents.airOpsAffected.label" default="Air Ops Affected" /></span>
				...
				<li class="fieldcontain">
					<span id="source-label" class="property-label"><g:message code="incidents.source.label" default="Source" /></span>
				...
				<li class="fieldcontain">
					<span id="entered-label" class="property-label"><g:message code="incidents.entered.label" default="Created By" /></span>
				...
				<g:if test="${incidents?.createdDate}">
					<li class="fieldcontain">
						<span id="createdDate-label" class="property-label"><g:message code="incidents.createdDate.label" default="Created" /></span>
				...
				<li class="fieldcontain">
					<span id="updatedDate-label" class="property-label"><g:message code="incidents.updatedDate.label" default="Updated" /></span>
				...
				<g:if test="${incidents?.entered}">
					<li class="fieldcontain">
						<span id="eventSourceHan-label" class="property-label"><g:message code="incidents.eventSourceHan.label" default="App" /></span>
