			...
			<table>
				<thead>
					<tr>
						...
						%{--<g:sortableColumn property="id" title="${message(code: 'currentIncident.eventDescHan.label', default: '서술')}"/>--}%

						<th id="hangul_desc_header" class="sortable"><a href="currentIncidents">서술</a></th>
				...
				<g:each in="${currentIncidentsList}" status="i" var="currentIncidents">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link absolute="true" url="/map/app.jsp?site=geocmt&lod=17&mgrs=${fieldValue(bean: currentIncidents, field: "mgrsCoord")}">
